...
{
    public class GlossaryAdminViewAggregator : IGlossaryAdminViewAggregator
    {
            ...
            bool isAdmin)
        {
            ...
            string U(int? id)
            {
                if (id.HasValue && userMap.TryGetValue(id.Value, out var name))
                    return name;
            ...
            bool AreIdentical(UnifiedTermDTO? a, UnifiedTermDTO? b)
            {
                if (a == null || b == null) return false;
                return a.Term.Trim() == b.Term.Trim() &&
            ...
            return flat
                ...
                .SelectMany(g =>
                {
                    ...
                    bool identical = AreIdentical(activeItem, archivedItem);
